...
const MOCK_STATS: StatCard[] = [
  {
    ...
    value: 24,
    subtitle: '8 bài đã quá hạn chấm',
    icon: (
    ...
    // BR-19: Có bài quá hạn → isUrgent = true → Card hiển thị màu đỏ/cam
    isUrgent: true,
    urgentLabel: '8 quá hạn',
  },
  {
    id: 'active-students',
    title: 'Sinh Viên Đang Học',
    value: 183,
    subtitle: 'Trên 4 khóa học đang mở',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
